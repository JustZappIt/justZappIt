  ...
  return (
    <section className="bg-[var(--color-surface)] border-b border-[var(--color-border)]">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        <p
          className="text-xs font-bold uppercase tracking-widest text-primary mb-4 animate-fade-in"
        ...
        <h1
          className="text-4xl sm:text-5xl font-extrabold text-[var(--color-text-primary)] leading-tight tracking-tight mb-4 animate-reveal-text"
        ...
        <p
          className="text-xl text-[var(--color-text-secondary)] mb-3 max-w-2xl mx-auto leading-relaxed animate-fade-up"
        ...
        <p
          className="text-base text-[var(--color-text-secondary)] mb-10 max-w-xl mx-auto leading-relaxed animate-fade-up"
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
          ...
          <Link
            href="/app"
            className="inline-flex items-center gap-2 bg-[var(--color-bg)] hover:bg-[var(--color-border)] text-[var(--color-text-primary)] font-semibold px-8 py-3 rounded-lg border border-[var(--color-border)] transition-all duration-200 text-base hover:-translate-y-0.5 hover:shadow-md animate-scale-in"
